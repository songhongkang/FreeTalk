...
/** 主题色 */
#define FT_COLOR_THEME FT_COLOR(11, 211, 166)


/************************** 尺寸宏 **********************/
#define FT_SCREEN_W [UIScreen mainScreen].bounds.size.width
#define FT_SCREEN_H [UIScreen mainScreen].bounds.size.height
